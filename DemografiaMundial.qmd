...
No vemos diferencias significativas por años en ningun continente.
...
espe_vida <- world_population %>% 
  group_by(Continente) %>% 
  drop_na() %>% 
  summarise(med = mean(Esp_vida),Esp_vida, Año)


ggplot(espe_vida, aes(x=Continente, y = Esp_vida, fill = Continente)) + 
  geom_violin() + 
